...
for(j in c("Table11","Table3_FirstDose", "Table3_ThirdDose")){
  ...
  st <- which(Correct[["LABEL"]] == "Socio economic status, n (%)")
...
first <- readRDS(paste0(InterMediateFolder, "/Table3_FirstDose.rds"))
second <- readRDS(paste0(InterMediateFolder, "/Table3_ThirdDose.rds"))
